...
`ttt_terminal` is passed to `Game` below as the stopping criterion.  It checks the board
for any three-in-a-row using the structural rules defined above, applying `F` to derive
the O-side variants.
