...
edge-related foreign keys in total. Separating rows, columns, and diagonals
into distinct tables lets win-detection patterns refer specifically to each
orientation without over-generating matches. Let's look at how we implement this schema in RewriteGames.jl,
...
but we still need to say **who** plays and **what** the winning conditions are.  This
section connects the three remaining pieces:
