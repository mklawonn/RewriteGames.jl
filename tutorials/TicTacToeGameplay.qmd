...
|--------------|-------|------------------|
| `Sq` nodes   | 9     | `[1,0,0,0,0,0]`  |
| `RowE` nodes | 6     | `[0,1,0,0,0,0]`  |
| `ColE` nodes | 6     | `[0,0,1,0,0,0]`  |
| `DiagE` nodes| 4     | `[0,0,0,1,0,0]`  |
| `X` nodes    | 0–9   | `[0,0,0,0,1,0]`  |
| `O` nodes    | 0–9   | `[0,0,0,0,0,1]`  |
...
```
one-hot type (6)
    └── Dense(6→16, relu)          node embedding
